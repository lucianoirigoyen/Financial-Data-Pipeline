...
class AlphaVantageCompleteProcessor:
    ...
    def _make_api_request(self, function: str, symbol: str, from_currency: str = None,
        ...
        # Configurar parámetros según el tipo de request
    ...
    def _translate_all_text_fields(self, data: Dict) -> Dict:
        ...
        # Identificar campos de texto dinámicamente
    ...
    def _normalize_all_numeric_fields(self, data: Dict) -> Dict:
        ...
        # Identificar campos numéricos dinámicamente
    ...
    def process_crypto(self, symbol: str) -> Dict:
        ...
        # Hacer request para datos de crypto
        ...
        # Extraer datos de metadata y precios más recientes
        try:
            ...
            # Crear estructura de datos similar a acciones
            processed_data = {
                'Symbol': symbol,
            ...
            # Normalizar campos numéricos específicos de crypto
            ...
            # Generar análisis específico para crypto
    ...
    def _generate_crypto_analysis(self, data: Dict) -> Dict:
        ...
        # Calcular volatilidad diaria si tenemos datos
        try:
    ...
    def process_stock(self, symbol: str) -> Dict:
        ...
        # Combinar datos y análisis
        result = {**data, **analysis, 'asset_type': 'stock'}

        # Generar Excel COMPLETO para la acción
    ...
    def _generate_consolidated_excel(self, all_results: Dict) -> None:
        ...
        try:
            with pd.ExcelWriter(filename, engine='openpyxl') as writer:
                ...
                # HOJA 2: TODAS LAS ACCIONES CONSOLIDADAS
                ...
                # HOJA 3: TODAS LAS CRIPTOMONEDAS CONSOLIDADAS
                ...
                # HOJA 5: ANÁLISIS COMPARATIVO DE ACCIONES
                if all_results['stocks']:
                    comparative_stocks = []
                    for stock in all_results['stocks']:
                        comp_row = {
                ...
                # HOJA 6: DATOS RAW COMPLETOS DE ACCIONES
                if all_results['stocks']:
                    raw_stocks_data = []
                    for stock in all_results['stocks']:
                        # Aplanar todos los datos de la acción
                        flat_data = {'Símbolo': stock.get('Symbol', '')}

                        # Añadir todos los campos principales
                        ...
                        # Añadir datos de análisis aplanados
                ...
                # HOJA 7: DATOS RAW COMPLETOS DE CRYPTOS
                if all_results['cryptos']:
                    raw_crypto_data = []
                    for crypto in all_results['cryptos']:
                ...
                # HOJA 8: DATOS RAW COMPLETOS DE FOREX
                if all_results['forex']:
                    raw_forex_data = []
                    for forex in all_results['forex']:
