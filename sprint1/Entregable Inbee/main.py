...
# Importar módulos locales con las nuevas clases dinámicas
from alpha_vantage import AlphaVantageCompleteProcessor
...
class InBeePipeline:
    ...
    def __init__(self):
        ...
        # Inicializar procesadores dinámicos
        self.alpha_vantage_processor = AlphaVantageCompleteProcessor()
        self.fondos_processor = FondosMutuosProcessor()
    ...
    def procesar_accion(self, symbol: str) -> Dict:
        ...
        try:
            resultado = self.alpha_vantage_processor.process_stock(symbol)
    ...
    def procesar_fondo(self, fondo_id: str) -> Dict:
        ...
        try:
            resultado = self.fondos_processor.procesar_fondos_mutuos(fondo_id)
    ...
    def procesar_batch_acciones(self, symbols: List[str], delay: float = 12.0) -> Dict:
        ...
        for i, symbol in enumerate(symbols):
            ...
            # Aplicar delay si no es la última iteración
            if i < len(symbols) - 1:
